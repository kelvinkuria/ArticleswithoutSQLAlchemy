...
class TestMagazine:
    ...
    def test_name_len(self):
        ...
        # Attempting to change the name to an invalid length should not modify the name
    ...
    def test_category_len(self):
        ...
        # Attempting to set an empty string should not modify the category
        magazine_1.category = ""
        assert magazine_1.category == "Fashion"
    ...
    def test_articles_of_type_articles(self):
        ...
        for article in magazine_2.articles():
            assert isinstance(article, Article)
    ...
    def test_contributors_of_type_author(self):
        ...
        for contributor in magazine_1.contributors():
            assert isinstance(contributor, Author)
    ...
    def test_article_titles(self):
        ...
        assert magazine_1.article_titles() is not None
