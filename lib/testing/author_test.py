...
class TestAuthor:
    ...
    def test_name_is_immutable_string(self):
        ...
        # Attempting to change the name should not affect the object
    ...
    def test_name_len(self):
        ...
        # An empty string should raise an exception
    ...
    def test_articles_of_type_articles(self):
        ...
        for article in author_2.articles():
            assert isinstance(article, Article)
    ...
    def test_magazines_of_type_magazine(self):
        ...
        for magazine in author_2.magazines():
            assert isinstance(magazine, Magazine)
